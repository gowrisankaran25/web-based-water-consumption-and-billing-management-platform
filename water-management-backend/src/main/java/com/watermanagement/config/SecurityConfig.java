...
import com.watermanagement.security.AuthTokenFilter;
import com.watermanagement.security.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/communityadmin/**").hasAnyRole("SUPER_ADMIN", "COMMUNITY_ADMIN")
